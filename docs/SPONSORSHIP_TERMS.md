...
of everything it receives under these pledges — 1% of the 2% — to the Celo
Community Fund.
...
in the operating ledger as `months_funded`, and the pledge attestation carries
it as `monthsFundedAtSigning` so the arithmetic is checkable by anyone.
