...
Version: `prezenti-sponsorship-trial-2026-08-18-v4`
...
Applications close when the fifth place is filled, or on 2026-12-29, whichever
comes first. Places are filled as builders are selected rather than in a single
round, so applying early is worth more than applying well before the backstop
date.

Each builder's own four-month term runs from their acceptance, not from a shared
start, so a builder accepted late still receives four months. The trial's first
term starts in 2026-09 and the last possible term ends on 2027-04-30, four months
after the latest date an application can be accepted.
